...
2. 2025-12-07： More Loss
   - Texture Loss && Color Consistency Loss
   
3. ~~2025-12-09： per-channel normalization && slight adjustment of DIP~~
   - ~~VOC_dark : **[PSNR 20.909], [SSIM 0.825]**~~
   - ~~VOC_fog:  **[PSNR 19.136], [SSIM 0.818]**~~

4. 2025-12-11： New Code Structure && New Loss && New Vision Encoder
